...
const Hero = () => {
  return (
    <section
      id="home"
      className="pt-28 pb-20 max-w-6xl mx-auto px-6 md:px-10 flex flex-col-reverse md:flex-row gap-8 items-center md:justify-between relative"
    >
      {/* Left Content */}
      <div className="flex flex-col flex-1 gap-4 leading-loose">
        <motion.p
          className="text-xl lg:text-2xl font-medium text-gray-200"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
        ...
        <motion.div
          className="text-2xl lg:text-3xl font-semibold min-h-[3rem] sm:min-h-[4rem]"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        <motion.p
          className="lg:text-lg text-gray-300 max-w-xl text-justify"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
